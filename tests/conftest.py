...
TEST_DATABASE_URL = "sqlite+aiosqlite:///:memory:"  # SQLite memória
...
def mock_redis_queue(monkeypatch):
	...
	async def fake_enqueue(payload: dict):  # noqa: D401
		calls.append(payload)

	async def fake_dequeue_batch(max_items: int):  # not used in API tests
